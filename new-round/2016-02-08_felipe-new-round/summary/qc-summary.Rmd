...
library(DEGreport)
library(vsn)
summarydata$treatment_fixed = as.character(summarydata$treatment)
summarydata$treatment_fixed[summarydata$treatment_fixed == "LPS+IL27"] = "LPS_with_IL27"
design = ~group+phenotype+treatment_fixed
# page 37 from DESeq2 manual https://www.bioconductor.org/packages/3.3/bioc/vignettes/DESeq2/inst/doc/DESeq2.pdf
design = ~phenotype + phenotype:group + phenotype:treatment
condition = "phenotype"
```
